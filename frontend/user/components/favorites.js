...
function renderFavoritesGrid() {
    ...
    if (sortedFavorites.length === 0) {
        ...
        grid.innerHTML = `
            <div class="favorites-empty">
                ...
                <a class="favorites-empty-link" href="/frontend/products.html">مشاهده محصولات</a>
            </div>
        `;
    ...
    grid.innerHTML = pageItems.map(product => {
        ...
        return `
            ...
            <a class="favorite-card" href="/frontend/cart.html?id=${product._id}" data-id="${product._id}">
